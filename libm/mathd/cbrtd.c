...
B1 = 715094163U, /* B1 = (682-0.03306235651)*2**20 */
B2 = 696219795U; /* B2 = (664-0.03306235651)*2**20 */
...
double cbrt(double x)
{
    ...
    if (hx < 0x00100000U) {    /* subnormal number */
        SET_HIGH_WORD(t, 0x43500000U);   /* set t= 2**54 */
        t *= x;
        GET_HIGH_WORD(high, t);
        SET_HIGH_WORD(t, high / 3U + B2);
    } else {
        SET_HIGH_WORD(t, hx / 3U + B1);
    }
    ...
    GET_HIGH_WORD(high, t);
    INSERT_WORDS(t, high + 0x00000001U, 0U);
